      ...
      <div className="container py-12 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p>
              <strong>Subscription Fees:</strong> Subscription fees are billed in advance on a monthly basis and are non-refundable except as required by law.
            </p>
            <p>
              <strong>Cancellation:</strong> You may cancel your subscription at any time through your account settings. Cancellation will take effect at the end of your current billing period. You will retain access to the platform until the end of the paid period.
            </p>
            <p>
              <strong>Changes to Fees:</strong> We reserve the right to modify subscription fees with at least 30 days' advance notice. Continued use of the platform after a fee change constitutes acceptance of the new fees.
            </p>
            <p>
              <strong>No Content Guarantees:</strong> Your subscription provides access to platform features and tools. We do not guarantee the availability of specific content, as content availability may vary based on user contributions and platform updates.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              <strong>Platform IP:</strong> All content, features, functionality, and intellectual property of the ONLYDJS platform, including but not limited to software, text, graphics, logos, and trademarks, are owned by ONLYDJS or its licensors and are protected by copyright, trademark, and other intellectual property laws.
            </p>
            <p>
              <strong>User Content IP:</strong> Users retain all ownership rights to content they upload. ONLYDJS does not claim ownership of user-generated content.
            </p>
            <p>
